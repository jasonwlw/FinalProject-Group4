...
pneumonia_dataset = datasets.ImageFolder(root='../chest_xray/train',transform=data_transforms['train'])
pneumonia_val_dataset = datasets.ImageFolder(root='../chest_xray/val',transform=data_transforms['val'])
...
vgg16 = train_model(vgg16, criterion, optimizer_ft, scheduler = None,num_epochs=N_EPOCHS)
