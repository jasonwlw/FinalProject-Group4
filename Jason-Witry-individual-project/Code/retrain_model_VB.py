...
pneumonia_dataset = datasets.ImageFolder(root='../chest_xray_256x256_VB/train',transform=data_transforms['train'])
pneumonia_val_dataset = datasets.ImageFolder(root='../chest_xray_256x256_VB/val',transform=data_transforms['val'])
